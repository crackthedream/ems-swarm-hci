            ...
            <div className="absolute inset-0 flex items-center z-20">
              <div className="max-w-4xl px-6 py-8 text-center md:text-left">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-3 md:gap-4">
                  <Link href="/system" className="btn-primary">System</Link>
                  <Link href="/interaction" className="btn-primary">Interaction</Link>
                  <Link href="/experiment" className="btn-accent">Experiment</Link>
                  <Link href="/team" className="btn-accent">Team</Link>
                </div>
              </div>
